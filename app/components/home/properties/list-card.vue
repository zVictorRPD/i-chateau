...
<template>
  <div
    class="flex w-full max-w-[840px] max-h-52 gap-2 border rounded-md border-gray-300 hover:shadow-md transition-shadow duration-200"
  >
    <div class="w-5/12">
      <Swiper
        :slides-per-view="1"
        ...
        class="h-full"
      >
        <SwiperSlide v-for="n in 3" :key="n" class="h-full">
          <div class="h-full">
            <NuxtImg
